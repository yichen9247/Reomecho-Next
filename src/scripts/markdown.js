 ...
 * @returns string
 */
const renderMarkdown = (data, alias) => {
    ...
    renderer.image = (src) => {
        if (!utils.checkStringUrl(src)) src = siteConfig.system.server_adress + '/api/' + alias + '/' + src;
    ...
    renderer.code = (code,language) => {
        if (NextEchoStore.configArticle.code_highlight) {
            if (language === '') {
                language = 'other';
