<script setup lang="ts">
    ...
    const MusicEchoStore = utils.useMusicEchoStore();
    ...
    <div style="height: 100%;width: 100%;display: flex;flex-direction: column;" v-if="!MusicEchoStore.musicloading">
        ...
        <div class='player'>
            <div class="player_disk">
                <div class="disk_img">
                    <img class="disk-bg" :src="utils.checkStringUrl(playSongSrc.img) ? playSongSrc.img : siteConfig.system.server_adress + '/api' + playSongSrc.img" draggable="false"/>
